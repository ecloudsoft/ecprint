...
// document.querySelector("#printHelpDoc").onclick = function(){
//   window.open('docs/getting-started/quick-start.html');
// }  


// document.querySelector("#printDownload").onclick = function(){
//   document.querySelector("#downloadPrint").scrollIntoView(true);
// }  
